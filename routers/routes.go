...
func SetupRoutes(app *fiber.App) {
	...
	v5 := api.Group("/project")
	v5.Post("/create", handlers.CreateProject)
	v5.Get("/read", handlers.GetAllProjects)
	v5.Get("/read/:id", handlers.GetProject)
	v5.Patch("/update/:id", handlers.UpdateProject)
	v5.Delete("/delete/:id", handlers.DeleteProject)
	v5.Delete("/hard/:id", handlers.HardDeleteProject)
	v5.Post("/convert/:id", handlers.ConvertToProject)
	v5.Post("/recover/:id", handlers.RecoverProject)
	v5.Get("/search", handlers.SearchProjects)
	v5.Get("/filter", handlers.FilterAllProjects)
